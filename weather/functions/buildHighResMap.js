...
async function main() {
  ...
  // Keep the approved-layout scale exactly the same. Pull the full PSA map
  // down slightly to create cleaner separation from the title/info panel.
  // graphics.js applies translate(95 10) scale(.97) after these local coordinates.
  const BOX = { x: 112, y: 125, w: 880, h: 760 };
